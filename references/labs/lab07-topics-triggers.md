...
4. Configure the topic:
   ...
   - Trigger description:
     ```
     This topic helps users find devices that are available from
     our SharePoint Devices list.
     ```
...
3. Add guidance to use the topic:
   ```
   - Help find available devices using [Available devices].
     Always extract the VarDeviceType from the inputs.
   ```
4. Save changes
...
## Next Steps
Proceed to [Lab 8: Enhance User Interactions with Adaptive Cards](./lab08-adaptive-cards.md)
