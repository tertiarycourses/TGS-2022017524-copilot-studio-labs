...
3. Use the conversational creation experience:
   ```
   I want to create an IT helpdesk agent that helps employees troubleshoot
   common technical issues. It should be friendly, professional, and provide
   step-by-step guidance. The agent should answer questions about software,
...
2. Add a **Public website**:
   - Select **Add knowledge** → **Public websites**
   - URL: `https://support.microsoft.com`
   - This provides Microsoft's official support documentation

3. Add a **SharePoint** connection:
   - Select **Add knowledge** → **SharePoint**
   - Connect to your Contoso IT SharePoint site
   - This provides internal documentation access

4. Upload a **Document**:
   - Select **Add knowledge** → **Files**
   - Upload your IT guidance document
   - This adds organization-specific policies
...
## Next Steps
Proceed to [Lab 7: Add New Topic with Trigger and Nodes](./lab07-topics-triggers.md)
