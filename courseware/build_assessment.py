...
Two instruments, each as a question paper + a model-answer / marking guide:
  ...
  1. Written Assessment (WA)  — tests KNOWLEDGE. Every item is drawn from the
     concept modules and slides taught in class (Modules 1-4).
  2. Case Study (CS) Assessment — tests PRACTICAL ability. One coherent case
     study (ACME Pte Ltd) built from the in-class activities; the model answers
     are the exact build steps from the hands-on labs.
