...
2. Add:
   ```
   When processing resumes from email triggers, use the
   Teams Notification flow to alert the HR recruitment team.
   Include the candidate name and link to the Dataverse record.
   ```
3. Save changes
...
## Next Steps
Proceed to [Lab 17: Understanding Agent Models](./lab17-agent-models.md)
