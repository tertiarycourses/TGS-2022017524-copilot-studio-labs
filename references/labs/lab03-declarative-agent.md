...
4. Use the conversational creation experience:
   ```
   You are a highly skilled IT professional specializing in computer systems,
   networking, and cybersecurity. You diagnose and solve technical issues,
   explain solutions clearly for all technical levels, and provide guidance
   on best practices.
   ```
5. Name your agent: `Contoso Tech Support Pro`
6. Refine instructions for IT-focused scenarios
7. Skip adding websites/knowledge (we'll add a prompt instead)
...
2. Add instruction to invoke the prompt:
   ...
   Use their question as the problem input.
   ```
3. Save changes
...
3. Expand **Agent Debug Info** to review:
   - Matched actions
   - Selected actions
   - Executed actions
...
## Next Steps
Proceed to [Lab 4: Creating a Solution for Your Agent](./lab04-creating-solution.md)
