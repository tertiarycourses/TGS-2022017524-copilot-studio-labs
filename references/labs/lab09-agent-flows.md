...
2. Compare with Power Automate cloud flows:
   ...
   |-------------|-------------|
   | Built for agents | General-purpose |
   | In Copilot Studio | Power Automate portal |
   | No separate license | Requires license |
   | Agent-only visibility | Shareable/reusable |
...
3. Configure the trigger with inputs:
   ...
   |------|------|-------------|
   | Text | `DeviceSharePointId` | The SharePoint item ID |
   | Text | `User` | The user's name |
   | Text | `AdditionalComments` | Optional user comments |
...
## Next Steps
Proceed to [Lab 10: Add Event Triggers for Autonomous Agents](./lab10-event-triggers.md)
